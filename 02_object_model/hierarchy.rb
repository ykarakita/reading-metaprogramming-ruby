...
class C4
  def increment
    ...
    # value = v + 1 # なぜこれじゃだめ？
    # => 調べた。
    # これだとローカル変数に値を代入しただけと解釈されてしまうらしい
    # そのためセッターメソッドを呼び出すときは self をつける必要あり
    # private メソッドは self つきで呼び出せないが、セッターメソッドなら private メソッドでも呼び出せる
    # @value = v + 1 でも OK というかこうしたほうがわかりやすくてよいとのこと
